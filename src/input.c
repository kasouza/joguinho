...
static int mouse_button_to_glfw_mouse_button[] = {
...
static int glfw_mouse_button_to_mouse_button[] = {
...
static int input_action_to_glfw_action[] = {
    [PRESS] = GLFW_PRESS,
    [RELEASE] = GLFW_RELEASE,
};

static int glfw_action_to_input_action[] = {
    [GLFW_PRESS] = PRESS,
